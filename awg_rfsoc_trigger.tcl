...
proc create_root_design { parentCell } {
  ...
  # Create instance: awg_BRAM_parity_0, and set properties
  set block_name awg_BRAM_parity
  set block_cell_name awg_BRAM_parity_0
  if { [catch {set awg_BRAM_parity_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $awg_BRAM_parity_0 eq "" } {
  ...
  # Create instance: gpio_data_in, and set properties
  set gpio_data_in [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 gpio_data_in ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.DAC0_Fabric_Freq {583.680} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR0 {50} \
  ...
  connect_bd_intf_net -intf_net awg_BRAM_parity_0_m00_axis [get_bd_intf_pins awg_BRAM_parity_0/m00_axis] [get_bd_intf_pins usp_rf_data_converter_0/s00_axis]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins col/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins gpio_data_in/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins ps8_0_axi_periph/M04_AXI] [get_bd_intf_pins row/S_AXI]
  ...
  connect_bd_net -net MAX_POINTS_gpio_io_o [get_bd_pins MAX_POINTS/gpio_io_o] [get_bd_pins awg_BRAM_parity_0/MAX_POINTS]
  connect_bd_net -net col_gpio_io_o [get_bd_pins awg_BRAM_parity_0/col] [get_bd_pins col/gpio_io_o]
  connect_bd_net -net control_trigger_0_1 [get_bd_ports control_trigger_0] [get_bd_pins awg_BRAM_parity_0/control_trigger]
  connect_bd_net -net gpio_data_in_gpio_io_o [get_bd_pins awg_BRAM_parity_0/gpio_data_in] [get_bd_pins gpio_data_in/gpio_io_o]
  ...
  connect_bd_net -net row_gpio_io_o [get_bd_pins awg_BRAM_parity_0/row] [get_bd_pins row/gpio_io_o]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins MAX_POINTS/s_axi_aresetn] [get_bd_pins col/s_axi_aresetn] [get_bd_pins gpio_data_in/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins row/s_axi_aresetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn] [get_bd_pins we/s_axi_aresetn]
  ...
  connect_bd_net -net util_ds_buf_0_BUFG_O [get_bd_pins awg_BRAM_parity_0/m00_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk] [get_bd_pins util_ds_buf_0/BUFG_O]
  connect_bd_net -net we_gpio_io_o [get_bd_pins awg_BRAM_parity_0/we] [get_bd_pins we/gpio_io_o]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins MAX_POINTS/s_axi_aclk] [get_bd_pins awg_BRAM_parity_0/wclk] [get_bd_pins col/s_axi_aclk] [get_bd_pins gpio_data_in/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins row/s_axi_aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins we/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs col/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs gpio_data_in/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs row/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs we/S_AXI/Reg] -force
